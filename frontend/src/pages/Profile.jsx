      ...
      <div className='bg-white shadow-lg rounded-2xl p-8 max-w-xl w-full relative'>
        ...
        <div className='flex flex-col items-center text-center'>
          ...
          <div className='w-24 h-24 rounded-full text-white flex items-center text-[30px] bg-black justify-center object-cover border-2 border-white'>
            ...
            <p className='text-xl text-gray-500'>{userData?.role}</p>
        </div>

        <div className='mt-6 space-y-4'>
            <div className='text-xl flex items-center justify-start gap-1'>
            ...
            <div className='text-xl flex items-center justify-start gap-1'>
             ...
             <div className='text-xl flex items-center justify-start gap-1'>
              <span className='font-semibold text-gray-700'>Enroller Courses:</span>
