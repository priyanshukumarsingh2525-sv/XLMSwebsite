...
const SearchWithAi = () => {
    ...
    const handleRecommendation = async (query) =>{
           ...
           try {
            ...
            console.log("handleRecommendation",error)
           }finally{
            setListening(false)
           }
    }
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-black to-gray-900 text-white flex flex-col items-center px-4 py-16'>
        ...
        <div className='bg-white shadow-xl rounded-3xl p-6 sm:p-8 w-full max-w-2xl text-center relative'>
           <FaArrowLeft className='text-black w-5.5 h-5.5 cursor-pointer absolute'onClick={()=>navigate('/')}/>
           <h1 className='text-2xl sm:text-3xl font-bold text-gray-600 mb-6 flex items-center justify-center gap-2'><img src={ai} alt="" className='w-8 h-8 sm:w-7.5 sm:h-7.5'/> Search With <span className='text-[#CB99C7]'>AI</span> </h1>

           <div className='flex items-center bg-gray-700 rounded-full overflow-hidden shadow-lg relative w-full p-2'>
